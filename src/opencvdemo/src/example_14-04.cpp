...
int main(int argc, char** argv) {
  ...
  Ptr<ShapeContextDistanceExtractor> mysc = cv::createShapeContextDistanceExtractor();

  Size sz2Sh(300,300);
  Mat img1=imread("E:/app/julia/Learning-OpenCV-3_examples/shape_sample/1.png", IMREAD_GRAYSCALE);
  Mat img2=imread("E:/app/julia/Learning-OpenCV-3_examples/shape_sample/3.png", IMREAD_GRAYSCALE);
