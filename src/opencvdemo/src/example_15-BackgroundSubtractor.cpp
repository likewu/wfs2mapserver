...
void help();
void processVideo(string videoFilename, int train);
void processImages(string firstFrameFilename, int train);
void help()
{
    cout
...
void processImages(string fistFrameFilename, int train) {
