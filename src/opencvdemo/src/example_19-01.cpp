...
int main(int argc, char *argv[]) {
  ...
  cv::FileStorage fs("E:/app/julia/Learning-OpenCV-3_examples/birdseye/intrinsics.xml", cv::FileStorage::READ);
  ...
  cv::Mat gray_image, image, image0 = cv::imread("E:/app/julia/Learning-OpenCV-3_examples/birdseye/IMG_0215L.jpg", 1);
  if (image0.empty()) {
