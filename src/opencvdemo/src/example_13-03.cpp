...
int main( int argc, char** argv ) {
  ...
  //
  if((templ=cv::imread("E:/app/julia/Learning-OpenCV-3_examples/BlueCup.jpg", 1)).empty()) {
  ...
  //
  if((src=cv::imread("E:/app/julia/Learning-OpenCV-3_examples/adrian.jpg", 1)).empty()) {
