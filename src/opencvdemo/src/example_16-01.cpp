...
int main(int argc, char** argv) {
    ...
    // results.
    //
    cv::Mat imgA = cv::imread("E:/app/julia/Learning-OpenCV-3_examples/example_16-01-imgA.png", cv::IMREAD_GRAYSCALE);
    cv::Mat imgB = cv::imread("E:/app/julia/Learning-OpenCV-3_examples/example_16-01-imgB.png", cv::IMREAD_GRAYSCALE);
    cv::Size img_sz = imgA.size();
    int win_size = 10;
    cv::Mat imgC = cv::imread("E:/app/julia/Learning-OpenCV-3_examples/example_16-01-imgB.png", cv::IMREAD_UNCHANGED);
