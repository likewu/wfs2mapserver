...
int main(int argc, char** argv) {
    ...
    string image_file_name = string("E:/app/julia/Learning-OpenCV-3_examples/faces.png");
    cv::Mat img = cv::imread(image_file_name, cv::IMREAD_COLOR);
    string cascade_file_name = string("E:/app/julia/Learning-OpenCV-3_examples/haarcascade_frontalface_alt.xml");
