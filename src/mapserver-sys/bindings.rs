...
extern "C" {
    pub fn msGetThreadId() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn msAcquireLock(arg1: ::std::os::raw::c_int);
}
extern "C" {
    pub fn msReleaseLock(arg1: ::std::os::raw::c_int);
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct errorObj {
...
extern "C" {
    pub fn msGetErrorString(delimiter: *mut ::std::os::raw::c_char) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn msSetError(
...
extern "C" {
    pub fn msFirstKeyFromHashTable(table: *mut hashTableObj) -> *const ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    pub fn msHashIsEmpty(table: *mut hashTableObj) -> ::std::os::raw::c_int;
}
...
extern "C" {
    pub fn msSetPROJ_LIB(arg1: *const ::std::os::raw::c_char, arg2: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn msProjLibInitFromEnv();
}
extern "C" {
...
extern "C" {
    pub fn msSHXLoadAll(psSHP: SHPHandle) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msSHXLoadPage(
        psSHP: SHPHandle,
        shxBufferPage: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msSHXReadOffset(
        psSHP: SHPHandle,
        hEntity: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msSHXReadSize(psSHP: SHPHandle, hEntity: ::std::os::raw::c_int)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msDBFOpen(
...
pub type MS_UNITS = ::std::os::raw::c_uint;
...
fn bindgen_test_layout_webObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<webObj>())).log as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(webObj),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<webObj>())).extent as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(webObj),
...
fn bindgen_test_layout_styleObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<styleObj>())).backgroundcolor as *const _ as usize },
        84usize,
        concat!(
            "Offset of field: ",
            stringify!(styleObj),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<styleObj>())).position as *const _ as usize },
        320usize,
        concat!(
            "Offset of field: ",
            stringify!(styleObj),
...
pub struct labelObj {
    ...
    pub maxstyles: ::std::os::raw::c_int,
    pub numstyles: ::std::os::raw::c_int,
    pub bindings: [attributeBindingObj; 9usize],
    pub numbindings: ::std::os::raw::c_int,
...
fn bindgen_test_layout_labelObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<labelObj>())).minlength as *const _ as usize },
        132usize,
        concat!(
            "Offset of field: ",
            stringify!(labelObj),
...
pub struct resultCacheObj {
    ...
    pub usegetshape: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_resultCacheObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<resultCacheObj>())).usegetshape as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(resultCacheObj),
            "::",
            stringify!(usegetshape)
        )
    );
}
#[repr(C)]
...
fn bindgen_test_layout_scalebarObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<scalebarObj>())).interlace as *const _ as usize },
        592usize,
        concat!(
            "Offset of field: ",
            stringify!(scalebarObj),
...
fn bindgen_test_layout_legendObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<legendObj>())).interlace as *const _ as usize },
        564usize,
        concat!(
            "Offset of field: ",
            stringify!(legendObj),
...
fn bindgen_test_layout_layerObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<layerObj>())).dump as *const _ as usize },
        872usize,
        concat!(
            "Offset of field: ",
            stringify!(layerObj),
...
pub struct mapObj {
    ...
    pub transparent: ::std::os::raw::c_int,
    pub interlace: ::std::os::raw::c_int,
    pub imagequality: ::std::os::raw::c_int,
    pub extent: rectObj,
    pub cellsize: f64,
    pub gt: geotransformObj,
...
fn bindgen_test_layout_mapObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<mapObj>())).transparent as *const _ as usize },
        488usize,
        concat!(
            "Offset of field: ",
            stringify!(mapObj),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<mapObj>())).interlace as *const _ as usize },
        492usize,
        concat!(
            "Offset of field: ",
            stringify!(mapObj),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<mapObj>())).imagequality as *const _ as usize },
        496usize,
        concat!(
            "Offset of field: ",
            stringify!(mapObj),
            "::",
            stringify!(imagequality)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn msGetPath(fn_: *mut ::std::os::raw::c_char) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn msBuildPath(
...
extern "C" {
    pub fn msCopySymbolSet(
        ...
        src: *mut symbolSetObj,
        map: *mut mapObj,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyHashTable(dst: *mut hashTableObj, src: *mut hashTableObj)
        -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn msCopyShape(from: *mut shapeObj, to: *mut shapeObj) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn msAddLine(p: *mut shapeObj, new_line: *mut lineObj) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn msComputeKernelDensityDataset(
        map: *mut mapObj,
        image: *mut imageObj,
        layer: *mut layerObj,
...
extern "C" {
    pub fn msCleanupKernelDensityDataset(
        map: *mut mapObj,
        image: *mut imageObj,
        layer: *mut layerObj,
...
extern "C" {
    pub fn msCopyMap(dst: *mut mapObj, src: *mut mapObj) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyLayer(dst: *mut layerObj, src: *mut layerObj) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyScaleToken(
        src: *mut scaleTokenObj,
        dst: *mut scaleTokenObj,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyPoint(dst: *mut pointObj, src: *mut pointObj) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn msCopyStyle(dst: *mut styleObj, src: *mut styleObj) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyLabel(dst: *mut labelObj, src: *mut labelObj) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyLabelLeader(
        dst: *mut labelLeaderObj,
        src: *mut labelLeaderObj,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyLine(dst: *mut lineObj, src: *mut lineObj) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn msCopyProjection(
        dst: *mut projectionObj,
        src: *mut projectionObj,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
pub struct rendererVTableObj {
    ...
    >,
    pub renderText: ::std::option::Option<
        unsafe extern "C" fn(
            img: *mut imageObj,
            labelpnt: *mut pointObj,
...
fn bindgen_test_layout_rendererVTableObj() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rendererVTableObj>())).renderText as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(rendererVTableObj),
            "::",
            stringify!(renderText)
        )
    );
    assert_eq!(
        unsafe {
...
extern "C" {
    pub fn msOGRIsSpatialite(layer: *mut layerObj) -> ::std::os::raw::c_int;
}
